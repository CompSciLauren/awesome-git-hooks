...
- [Git Hook Scripts](#git-hook-scripts)
  ...
  - [post-checkout hooks](#post-checkout-hooks)
  - [post-update hooks](#post-update-hooks)
  - [pre-commit hooks](#pre-commit-hooks)
  - [prepare-commit-msg hooks](#prepare-commit-msg-hooks)
  - [pre-push hooks](#pre-push-hooks)
  - [pre-rebase hooks](#pre-rebase-hooks)
  - [query-watchman hooks](#query-watchman-hooks)
